...
from app.api.routers import auth, users, vehicles, drivers, machines, maintenance, work_orders, suppliers, trips, tires, stats, setup, clients, gps, coordinator, fleet_assignments, alerts
