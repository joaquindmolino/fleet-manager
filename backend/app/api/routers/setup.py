...
_DEFAULT_ROLES: dict[str, set[tuple[str, str]]] = {
    ...
    "Encargado de mantenimiento": {
        ...
        ("mantenimiento", "ver"), ("mantenimiento", "crear"), ("mantenimiento", "editar"), ("mantenimiento", "cerrar"), ("mantenimiento", "aprobar"),
        ("ordenes_trabajo", "ver"), ("ordenes_trabajo", "crear"), ("ordenes_trabajo", "editar"), ("ordenes_trabajo", "cerrar"), ("ordenes_trabajo", "aprobar"),
